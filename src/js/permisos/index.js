...
const cargarAplicaciones = async () => {
    try {
        const respuesta = await fetch('/proyecto011/permisos/buscarAplicacionesAPI');
...
const guardarPermiso = async (e) => {
    ...
    try {
        ...
        const respuesta = await fetch('/proyecto011/permisos/guardar', {
            method: 'POST',
            body
        });
...
const buscarPermisos = async () => {
    try {
        ...
        const respuesta = await fetch('/proyecto011/permisos/buscarAPI');
        const data = await respuesta.json();
...
const modificarPermiso = async (e) => {
    ...
    try {
        const body = new FormData(formPermiso);
        const respuesta = await fetch('/proyecto011/permisos/modificarAPI', {
            method: 'POST',
            body
        });
...
const eliminarPermiso = async (e) => {
    ...
    if (confirmacion.isConfirmed) {
        try {
            const respuesta = await fetch(`/proyecto011/permisos/eliminarAPI?id=${id}`);
            const data = await respuesta.json();
