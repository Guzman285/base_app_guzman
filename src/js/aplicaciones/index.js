...
const guardarAplicacion = async (e) => {
    ...
    try {
        ...
        const respuesta = await fetch('/proyecto011/aplicaciones/guardar', {
            method: 'POST',
            body
        });
...
const buscarAplicaciones = async () => {
    try {
        ...
        const respuesta = await fetch('/proyecto011/aplicaciones/buscarAPI');
        const data = await respuesta.json();
...
const modificarAplicacion = async (e) => {
    ...
    try {
        const body = new FormData(formAplicacion);
        const respuesta = await fetch('/proyecto011/aplicaciones/modificarAPI', {
            method: 'POST',
            body
        });
...
const eliminarAplicacion = async (e) => {
    ...
    if (confirmacion.isConfirmed) {
        try {
            const respuesta = await fetch(`/proyecto011/aplicaciones/eliminarAPI?id=${id}`);
            const data = await respuesta.json();
