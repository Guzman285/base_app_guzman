...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const cargarUsuarios = async () => {
        const url = `/proyecto011/asignacionpermisos/buscarUsuariosAPI`;
        const config = {
            method: 'GET'
        }
    ...
    const cargarAplicaciones = async () => {
        const url = `/proyecto011/asignacionpermisos/buscarAplicacionesAPI`;
        const config = {
            method: 'GET'
        }
    ...
    const cargarTodosLosPermisos = async () => {
        const url = `/proyecto011/asignacionpermisos/buscarPermisosAPI`;
        const config = {
            method: 'GET'
        }
    ...
    const cargarPermisos = async (app_id) => {
        const url = `/proyecto011/asignacionpermisos/buscarPermisosAPI?app_id=${app_id}`;
        const config = {
            method: 'GET'
        }
    ...
    const guardarAsignacion = async e => {
        ...
        const url = "/proyecto011/asignacionpermisos/guardarAPI";
        const config = {
            method: 'POST',
            body
        }
    ...
    const BuscarAsignaciones = async () => {
        const url = `/proyecto011/asignacionpermisos/buscarAPI`;
        const config = {
            method: 'GET'
        }
    ...
    const ModificarAsignacion = async (event) => {
        ...
        const body = new FormData(formAsignacion);
        const url = '/proyecto011/asignacionpermisos/modificarAPI';
        const config = {
            method: 'POST',
            body
        }
    ...
    const RevocarAsignacion = async (e) => {
        ...
        if (AlertaConfirmarRevocar.isConfirmed) {
            const url = `/proyecto011/asignacionpermisos/revocar?id=${idAsignacion}`;
            const config = {
                method: 'GET'
            }
