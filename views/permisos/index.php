                        ...
                        <div class="row justify-content-center mt-4">
                            <div class="col-auto">
                                <p class="text-center text-muted">
                                    <a href="/proyecto011/registro" class="text-primary fw-bold">Gestionar Usuarios</a> | 
                                    <a href="/proyecto011/aplicaciones" class="text-primary fw-bold">Gestionar Aplicaciones</a> |
                                    <a href="/proyecto011/login" class="text-primary fw-bold">Cerrar Sesión</a>
                                </p>
                            </div>
                        </div>
                    </form>
